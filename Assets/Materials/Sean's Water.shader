...
Shader "Custom/Water Pro" {
    Properties {
        ...
        _WaveIntensity ("Wave Intensity", Range(1, 15)) = 1
        _WaveScrollSpeed ("Wave Scroll Speed", Range(-30, 30)) = 0
        _DetailNormals ("Detail Normals", 2D) = "bump" {}
        _DetailIntensity ("Detail Intensity", Range(1, 15)) = 1
        _DetailScrollSpeed ("Detail Scroll Speed", Range(-30, 30)) = 0
        _MinuteDetailNormals ("Minute Detail Normals", 2D) = "bump" {}
        _MinuteDetailIntensity ("Minute Detail Intensity", Range(1, 15)) = 1
        _MinuteDetailScrollSpeed ("Minute Detail Scroll Speed", Range(-30, 30)) = 0
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
